...
#import "Ranking100ViewController.h"
#import "RankingViewSelectViewController.h"

@interface Ranking100ViewController ()

@end

@implementation Ranking100ViewController
...
- (void)viewDidLoad
{
    ...
    if(num==0){
        ...
        NSString *str = [NSString stringWithFormat : @"30問中正解数ランキング"];
        str = [NSString stringWithFormat:@"%@",str];
        naviItem.title = str;
    }
